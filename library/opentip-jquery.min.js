  ...
  Opentip = (function () {
    function t(e, i, o, s) {
      ...
      (this.loaded = !1),
        ...
        (this.currentPosition = { left: 0, top: 0 }),
        (this.dimensions = { width: 200, height: 50 }),
        (this.content = ""),
        (this.redraw = !0),
        ...
        s["extends"] == null &&
          (s["extends"] = s.style != null ? s.style : t.defaultStyle),
        (h = [s]),
        (b = s);
      while (b["extends"]) {
      ...
      for (
        s = (f = this.adapter).extend.apply(f, [{}].concat(__slice.call(h))),
          s.hideTriggers = (function () {
            var t, e, i, o;
            for (i = s.hideTriggers, o = [], t = 0, e = i.length; e > t; t++)
              (r = i[t]), o.push(r);
            return o;
          })(),
          s.hideTrigger &&
            s.hideTriggers.length === 0 &&
            s.hideTriggers.push(s.hideTrigger),
      ...
      for (
        !s.ajax ||
          (s.ajax !== !0 && s.ajax) ||
          (s.ajax =
            this.adapter.tagName(this.triggerElement) === "A"
              ? this.adapter.attr(this.triggerElement, "href")
              : !1),
          s.showOn === "click" &&
            this.adapter.tagName(this.triggerElement) === "A" &&
            this.adapter.observe(this.triggerElement, "click", function (t) {
              return t.preventDefault(), t.stopPropagation(), (t.stopped = !0);
            }),
          s.target && (s.fixed = !0),
          s.stem === !0 && (s.stem = new t.Joint(s.tipJoint)),
          s.target === !0
            ? (s.target = this.triggerElement)
            : s.target && (s.target = this.adapter.wrap(s.target)),
          this.currentStem = s.stem,
          s.delay == null && (s.delay = s.showOn === "mouseover" ? 0.2 : 0),
          s.targetJoint == null &&
            (s.targetJoint = new t.Joint(s.tipJoint).flip()),
          this.showTriggers = [],
          ...
          s.ajaxCache != null && ((s.cache = s.ajaxCache), delete s.ajaxCache),
          this.options = s,
          this.bound = {},
    ...
    return (
      ...
      (t.prototype._setup = function () {
        ...
        for (
          ...
          if (
            ...
            (i = null),
            (t =
              this.options.hideOn instanceof Array
                ? this.options.hideOn[o]
                : this.options.hideOn),
            typeof e == "string")
          )
            switch (e) {
        ...
        for (p = this.hideTriggers, d = [], n = 0, a = p.length; a > n; n++)
          (e = p[n]),
            d.push(
      ...
      (t.prototype._buildContainer = function () {
        return (
          (this.container = this.adapter.create(
            '<div id="opentip-' +
              this.id +
              '" class="' +
          ...
          this.options.showEffect &&
            this.adapter.addClass(
              this.container,
              "" + this["class"].showEffectPrefix + this.options.showEffect
            ),
          this.options.hideEffect
            ? this.adapter.addClass(
                this.container,
                "" + this["class"].hideEffectPrefix + this.options.hideEffect
              )
            : void 0
        );
      }),
      (t.prototype._buildElements = function () {
        var t, e;
        return (
          (this.tooltipElement = this.adapter.create(
            '<div class="' +
              this["class"].opentip +
              '"><div class="' +
              this["class"].header +
          ...
          (this.backgroundCanvas = this.adapter.wrap(
          ...
          typeof G_vmlCanvasManager != "undefined" &&
            ...
            G_vmlCanvasManager.initElement(
              this.adapter.unwrap(this.backgroundCanvas)
            ),
          (t = this.adapter.find(
            this.tooltipElement,
            "." + this["class"].header
          ...
          this.options.title &&
            ((e = this.adapter.create("<h1></h1>")),
            this.adapter.update(
              e,
              this.options.title,
              this.options.escapeTitle
            ),
          ...
          this.options.ajax &&
            ...
            this.adapter.append(
              ...
              this.adapter.create(
                '<div class="' +
                  this["class"].loadingIndicator +
                  '"><span>↻</span></div>'
              )
            ),
          __indexOf.call(this.options.hideTriggers, "closeButton") >= 0 &&
            ((this.closeButtonElement = this.adapter.create(
      ...
      (t.prototype.setContent = function (t) {
        return (
          ...
          typeof this.content == "function"
            ? ((this._contentFunction = this.content), (this.content = ""))
      ...
      (t.prototype._updateElementContent = function () {
        ...
        return (
          (this._newContent ||
            (!this.options.cache && this._contentFunction)) &&
            ((t = this.adapter.find(
              this.container,
              "." + this["class"].content
            )),
      ...
      (t.prototype._storeAndLockDimensions = function () {
        ...
        if (this.container)
          return (
            ...
            this._dimensionsEqual(this.dimensions, t)
              ? void 0
              : ((this.redraw = !0), this._draw())
          );
      }),
      ...
      (t.prototype._setupObservers = function () {
        var t,
          ...
          m = this;
        for (
          o = arguments.length >= 1 ? __slice.call(arguments, 0) : [],
            n = 0,
            p = o.length;
          p > n;
          n++
          ...
          if (
            ...
            switch (
              ...
              (t = function () {
                var t, i, o;
                return (
                  (t = arguments.length >= 1 ? __slice.call(arguments, 0) : []),
                  e
                    ? (i = m.adapter).stopObserving.apply(i, t)
                    : (o = m.adapter).observe.apply(o, t)
                );
              }),
              i)
            ) {
              case "showing":
                for (c = this.hideTriggers, r = 0, d = c.length; d > r; r++)
                  (s = c[r]), t(s.element, s.event, this.bound.prepareToHide);
                t(
                  document.onresize != null ? document : window,
                  "resize",
                  this.bound.reposition
                ),
                  t(window, "scroll", this.bound.reposition);
                break;
              case "visible":
                for (
                  g = this.showTriggersWhenVisible, a = 0, l = g.length;
                  l > a;
                  a++
                )
                  (s = g[a]), t(s.element, s.event, this.bound.prepareToShow);
                break;
              case "hiding":
                for (f = this.showTriggers, h = 0, u = f.length; u > h; h++)
                  (s = f[h]), t(s.element, s.event, this.bound.prepareToShow);
                break;
              case "hidden":
                break;
              default:
        ...
        return (
          ...
          this.visible
            ...
            : (this.debug("Showing in " + this.options.delay + "s."),
              ...
              this.options.group &&
                t._abortShowingGroup(this.options.group, this),
              ...
              this.reposition(),
              (this._showTimeoutId = this.setTimeout(
                this.bound.show,
            ...
            : (this._clearTimeouts(),
              this._triggerElementExists()
                ? (this.debug("Showing now."),
                  ...
                  !this.options.ajax ||
                    (this.loaded && this.options.cache) ||
                    this._loadAjax(),
                  this._searchAndActivateCloseButtons(),
                  this._startEnsureTriggerElement(),
                  this.adapter.css(this.container, { zIndex: t.lastZIndex++ }),
                    ...
                    if (e.visible && !e.preparingToHide)
                      return (
                        ...
                        e.options.showEffect &&
                          e.options.showEffectDuration &&
                          (t = e.options.showEffectDuration),
                        e.setCss3Style(e.container, {
                          transitionDuration: "" + t + "s",
                        }),
                        (e._visibilityStateTimeoutId = e.setTimeout(
                          function () {
                            return (
                              e.adapter.removeClass(
                                e.container,
        ...
        return (
          ...
          this.visible
            ? (this.debug("Hiding in " + this.options.hideDelay + "s"),
              ...
              this._setupObservers("-showing", "visible", "-hidden", "hiding"),
              (this._hideTimeoutId = this.setTimeout(
                this.bound.hide,
          ...
          this.container)
            ? (this.adapter.removeClass(this.container, this["class"].visible),
              ...
              this.defer(function () {
                var e;
                return (
                  t.adapter.removeClass(t.container, t["class"].goingToHide),
                  t.adapter.addClass(t.container, t["class"].hiding),
                  (e = 0),
                  t.options.hideEffect &&
                    t.options.hideEffectDuration &&
                    (e = t.options.hideEffectDuration),
                  t.setCss3Style(t.container, {
                    transitionDuration: "" + e + "s",
                  }),
                  (t._visibilityStateTimeoutId = t.setTimeout(function () {
                    return (
                      t.adapter.removeClass(t.container, t["class"].hiding),
                      t.adapter.addClass(t.container, t["class"].hidden),
                      t.setCss3Style(t.container, { transitionDuration: "0s" }),
                      t.options.removeElementsOnHide
                        ? (t.debug("Removing HTML elements."),
      ...
      (t.prototype.reposition = function () {
        ...
        return (
          ...
          t == null ||
          ((e = this.options.stem),
          this.options.containInViewport &&
          ...
          this._positionsEqual(t, this.currentPosition))
            ...
            : (this.options.stem &&
              ...
              this.defer(function () {
                var t, e;
                return (
                  (t = o.adapter.unwrap(o.container)),
      ...
      (t.prototype.getPosition = function (t, e, i) {
        ...
        if (this.container)
          return (
            t == null && (t = this.options.tipJoint),
            e == null && (e = this.options.targetJoint),
            (r = {}),
            this.options.target
              ? ((p = this.adapter.offset(this.options.target)),
                (h = this.adapter.dimensions(this.options.target)),
                (r = p),
                e.right
                  ? ((d = this.adapter.unwrap(this.options.target)),
                    d.getBoundingClientRect != null
                      ? (r.left =
                          d.getBoundingClientRect().right +
                          ((l = window.pageXOffset) != null
                            ? l
                            : document.body.scrollLeft))
                      : (r.left += h.width))
                  : e.center && (r.left += Math.round(h.width / 2)),
                e.bottom
                  ? (r.top += h.height)
                  : e.middle && (r.top += Math.round(h.height / 2)),
                this.options.borderWidth &&
                  (this.options.tipJoint.left &&
                    (r.left += this.options.borderWidth),
                  this.options.tipJoint.right &&
                    (r.left -= this.options.borderWidth),
                  this.options.tipJoint.top
                    ? (r.top += this.options.borderWidth)
                    : this.options.tipJoint.bottom &&
                      (r.top -= this.options.borderWidth)))
              : (r = this.initialMousePosition
                  ? {
                      top: this.initialMousePosition.y,
                      left: this.initialMousePosition.x,
                    }
                  : { top: mousePosition.y, left: mousePosition.x }),
            this.options.autoOffset &&
              ((a = this.options.stem ? this.options.stemLength : 0),
              ...
              a &&
                (i == null && (i = this.options.stem),
                i.right ? (r.left -= a) : i.left && (r.left += a),
                i.bottom ? (r.top -= a) : i.top && (r.top += a))),
            (r.left += this.options.offset[0]),
            (r.top += this.options.offset[1]),
            t.right
              ? (r.left -= this.dimensions.width)
              : t.center && (r.left -= Math.round(this.dimensions.width / 2)),
            t.bottom
              ? (r.top -= this.dimensions.height)
              : t.middle && (r.top -= Math.round(this.dimensions.height / 2)),
            r
          );
      }),
      (t.prototype._ensureViewportContainment = function (e) {
        ...
        if (
          ((l = new t.Joint(this.options.tipJoint)),
          this.options.targetJoint &&
            (d = new t.Joint(this.options.targetJoint)),
        ...
        return i
          ? (this.options.stem && (h = l),
            ...
            o[0] &&
              ...
              this.options.targetJoint &&
                d.setHorizontal(this.options.targetJoint.horizontal)),
            o[1] &&
              o[1] !== p[1] &&
              ((r = !0),
              l.setVertical(this.options.tipJoint.vertical),
              this.options.targetJoint &&
                d.setVertical(this.options.targetJoint.vertical)),
            n && r
              ? s
              : ((n || r) &&
                  (this.options.stem && (h = l),
      ...
      (t.prototype._sticksOut = function (t) {
        ...
        return (
          ...
          (o = [!1, !1]),
          0 > e[0]
            ? (o[0] = this.STICKS_OUT_LEFT)
            : e[0] + this.dimensions.width > s.width &&
              (o[0] = this.STICKS_OUT_RIGHT),
          0 > e[1]
            ? (o[1] = this.STICKS_OUT_TOP)
            : e[1] + this.dimensions.height > s.height &&
      ...
      (t.prototype._draw = function () {
        ...
        if (this.backgroundCanvas && this.redraw) {
          if (
            ...
            for (
              v = ["top", "right", "bottom", "left"], f = 0, m = v.length;
              m > f;
              f++
            )
              (u = v[f]), this.adapter.removeClass(this.container, "stem-" + u);
            this.adapter.addClass(
              this.container,
              "stem-" + this.currentStem.horizontal
            ),
              this.adapter.addClass(
                this.container,
          ...
          return (
            ...
            __indexOf.call(this.options.hideTriggers, "closeButton") >= 0 &&
              ((n = new t.Joint(
                ((b = this.currentStem) != null ? b + "" : void 0) ===
                "top right"
                  ? "top left"
                  : "top right"
              )),
              (r = [
                this.options.closeButtonRadius +
                  this.options.closeButtonOffset[0],
                this.options.closeButtonRadius +
            ...
            (s = [0, 0]),
            this.options.borderWidth &&
              ((o.width += this.options.borderWidth * 2),
              (o.height += this.options.borderWidth * 2),
              (s[0] -= this.options.borderWidth),
              (s[1] -= this.options.borderWidth)),
            this.options.shadow &&
              ((o.width += this.options.shadowBlur * 2),
              (o.width += Math.max(
                0,
                this.options.shadowOffset[0] - this.options.shadowBlur * 2
              )),
              (o.height += this.options.shadowBlur * 2),
              (o.height += Math.max(
                0,
                this.options.shadowOffset[1] - this.options.shadowBlur * 2
              )),
              (s[0] -= Math.max(
                0,
                this.options.shadowBlur - this.options.shadowOffset[0]
              )),
              (s[1] -= Math.max(
                0,
                this.options.shadowBlur - this.options.shadowOffset[1]
              ))),
            (i = { left: 0, right: 0, top: 0, bottom: 0 }),
            this.currentStem &&
              (this.currentStem.left
                ? (i.left = this.options.stemLength)
                : this.currentStem.right && (i.right = this.options.stemLength),
              this.currentStem.top
                ? (i.top = this.options.stemLength)
                : this.currentStem.bottom &&
                  (i.bottom = this.options.stemLength)),
            n &&
              (n.left
                ? (i.left = Math.max(i.left, a[0]))
                : n.right && (i.right = Math.max(i.right, a[0])),
              n.top
                ? (i.top = Math.max(i.top, a[1]))
                : n.bottom && (i.bottom = Math.max(i.bottom, a[1]))),
            ...
            this.currentStem &&
              this.options.borderWidth &&
              ((w = this._getPathStemMeasures(
                this.options.stemBase,
                this.options.stemLength,
                this.options.borderWidth
              )),
              (g = w.stemLength),
              (c = w.stemBase)),
            ...
            h.beginPath(),
            (h.fillStyle = this._getColor(
              h,
              this.dimensions,
              this.options.background,
              this.options.backgroundGradientHorizontal
            )),
            (h.lineJoin = "miter"),
            (h.miterLimit = 500),
            (l = this.options.borderWidth / 2),
            this.options.borderWidth
              ? ((h.strokeStyle = this.options.borderColor),
                (h.lineWidth = this.options.borderWidth))
              : ((g = this.options.stemLength), (c = this.options.stemBase)),
            c == null && (c = 0),
            (d = function (t, e, i) {
              return (
                i &&
                  h.moveTo(
                    Math.max(c, _.options.borderRadius, r[0]) + 1 - l,
                    -l
                  ),
                e
                  ? (h.lineTo(t / 2 - c / 2, -l),
            ...
            (p = function (t, e, i) {
              ...
              return t
                ? (h.lineTo(-c + l, 0 - l),
                  ...
                  h.lineTo(l, c - l))
                : e
                ? ((a = _.options.closeButtonOffset),
                  (n = r[0]),
                  i % 2 !== 0 && ((a = [a[1], a[0]]), (n = r[1])),
                  ...
                  h.arc(
                    l - a[0],
                    -l + a[1],
                    _.options.closeButtonRadius,
                    -(Math.PI / 2 + o),
                    s,
                    !1
                  ))
                : (h.lineTo(-_.options.borderRadius + l, -l),
            ...
            (function () {
              ...
              for (
                f = [], i = c = 0, g = t.positions.length / 2;
                g >= 0 ? g > c : c > g;
                i = g >= 0 ? ++c : --c
              )
                (r = i * 2),
            ...
            h.save(),
            this.options.shadow &&
              ((h.shadowColor = this.options.shadowColor),
            ...
            n
              ? (function () {
                  var t, e, i, o, s;
                  return (
                    (i = e = _.options.closeButtonRadius * 2),
                    n + "" == "top right"
                      ? ((s = [
                          _.dimensions.width - _.options.closeButtonOffset[0],
                          _.options.closeButtonOffset[1],
                        ]),
                        (t = [s[0] + l, s[1] - l]))
                      : ((s = [
                          _.options.closeButtonOffset[0],
                          _.options.closeButtonOffset[1],
                        ]),
                        (t = [s[0] - l, s[1] - l])),
                    h.translate(t[0], t[1]),
                    ...
                    _.adapter.css(_.closeButtonElement, {
                      left:
                        "" +
                        (s[0] - o - _.options.closeButtonLinkOverscan) +
                        "px",
                      top:
                        "" +
                        (s[1] - o - _.options.closeButtonLinkOverscan) +
                        "px",
                      width:
                        "" +
                        (_.options.closeButtonCrossSize +
                          _.options.closeButtonLinkOverscan * 2) +
                        "px",
                      height:
                        "" +
                        (_.options.closeButtonCrossSize +
      ...
      (t.prototype._getColor = function (t, e, i, o) {
        ...
        for (
          n = o
            ? t.createLinearGradient(0, 0, e.width, 0)
            : t.createLinearGradient(0, 0, 0, e.height),
            r = a = 0,
            h = i.length;
          h > a;
          r = ++a
        )
          (s = i[r]), n.addColorStop(s[0], s[1]);
        return n;
      }),
      (t.prototype._searchAndActivateCloseButtons = function () {
        var t, e, i, o;
        for (
          o = this.adapter.findAll(this.container, "." + this["class"].close),
            e = 0,
            i = o.length;
          i > e;
          e++
        ...
        return (
          this.currentObservers.showing &&
            this._setupObservers("-showing", "showing"),
          this.currentObservers.visible
            ? this._setupObservers("-visible", "visible")
            : void 0
        );
      }),
      (t.prototype._activateFirstInput = function () {
        var t;
        return (
          (t = this.adapter.unwrap(
            this.adapter.find(this.container, "input, textarea")
          )),
          t != null
      ...
      (t.prototype._followMousePosition = function () {
        return this.options.fixed
          ? void 0
          : t._observeMousePosition(this.bound.reposition);
      }),
      (t.prototype._stopFollowingMousePosition = function () {
        return this.options.fixed
          ? void 0
          : t._stopObservingMousePosition(this.bound.reposition);
      }),
      ...
      (t.prototype._ensureTriggerElement = function () {
        return this._triggerElementExists()
          ? void 0
          : (this.deactivate(), this._stopEnsureTriggerElement());
      }),
        ...
        __hasProp.call(e, i) &&
          ...
          t.style[i] != null
            ...
            : r.push(
                function () {
                  var e, r, a;
                  for (a = [], e = 0, r = vendors.length; r > e; e++)
                    (s = vendors[e]),
    ...
    mouseMoved = function (t) {
      var e, i, o, s;
      for (
        mousePosition = Opentip.adapter.mousePosition(t),
          s = [],
          i = 0,
          o = mousePositionObservers.length;
        o > i;
        i++
      )
        (e = mousePositionObservers[i]), s.push(e());
      return s;
    },
    ...
    Opentip._stopObservingMousePosition = function (t) {
      ...
      return (mousePositionObservers = (function () {
        var i, o, s;
        for (s = [], i = 0, o = mousePositionObservers.length; o > i; i++)
          (e = mousePositionObservers[i]), e !== t && s.push(e);
        return s;
      })());
    },
    Opentip.Joint = (function () {
      ...
      return (
        ...
        (t.prototype.setHorizontal = function (t) {
          var e, i, o, s, n, r, a;
          for (i = ["left", "center", "right"], o = 0, n = i.length; n > o; o++)
            (e = i[o]), ~t.indexOf(e) && (this.horizontal = e.toLowerCase());
          for (
            this.horizontal == null && (this.horizontal = "center"),
              a = [],
              s = 0,
              r = i.length;
            r > s;
            ...
            (e = i[s]), a.push((this[e] = this.horizontal === e ? e : void 0));
          return a;
        }),
        (t.prototype.setVertical = function (t) {
          var e, i, o, s, n, r, a;
          for (i = ["top", "middle", "bottom"], o = 0, n = i.length; n > o; o++)
            (e = i[o]), ~t.indexOf(e) && (this.vertical = e.toLowerCase());
          for (
            this.vertical == null && (this.vertical = "middle"),
              a = [],
              s = 0,
              r = i.length;
            r > s;
            ...
            (e = i[s]), a.push((this[e] = this.vertical === e ? e : void 0));
          return a;
        }),
        ...
        (t.prototype.flip = function () {
          var t, e;
          return (
            (e = Opentip.position[this.toString(!0)]),
            (t = (e + 4) % 8),
    ...
    Opentip.prototype._dimensionsEqual = function (t, e) {
      return (
        t != null && e != null && t.width === e.width && t.height === e.height
      );
    },
    Opentip.prototype.debug = function () {
      ...
      return (
        ...
        (typeof console != "undefined" && console !== null
          ? console.debug
          : void 0) != null
          ? (t.unshift("#" + this.id + " |"), console.debug.apply(console, t))
          : void 0
      );
    },
    Opentip.findElements = function () {
      ...
      for (
        ...
        (i = h[r]),
          ...
          (e = t.data(i, "ot")),
          (e === "" || e === "true" || e === "yes") &&
            ((e = t.attr(i, "title")), t.attr(i, "title", "")),
          (e = e || "");
    ...
    Opentip._abortShowingGroup = function (t, e) {
      var i, o, s, n, r;
      for (n = Opentip.tips, r = [], o = 0, s = n.length; s > o; o++)
        (i = n[o]),
          i !== e && i.options.group === t
            ? r.push(i._abortShowing())
            : r.push(void 0);
      return r;
    },
        ...
        (e.prototype.ajax = function (e) {
          ...
          return t
            .ajax({
              url: e.url,
              type:
                (i = (o = e.method) != null ? o.toUpperCase() : void 0) != null
                  ? i
                  : "GET",
            })
            .done(function (t) {
            ...
            .fail(function (t) {
              return typeof e.onError == "function"
                ? e.onError("Server responded with status " + t.status)
                : void 0;
            })
            .always(function () {
              return typeof e.onComplete == "function"
                ? e.onComplete()
                : void 0;
            });
        }),
